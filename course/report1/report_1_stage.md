---
## Front matter
title: "Отчет о прохождении 1 раздела внешних курсов"
subtitle: "Введение"
...
Стандартная операционная система, предлагаемая большей частью магазинов - windows, именно она стоит у меня на основном компьютере. Linux установлен на моей виртуальной машине, им я пользуюсь для выполнения лабораторных работ.
...
Я просмотрела курс и освежила в памяти навыки работы с архивами, скачивание файлов, команды и тп.
